...
await update("apps/web/app/coverage/page.tsx", (source) => {
  let next = replaceOnce(source, importAnchor, importWithConfirm, "coverage import");
  next = replaceOnce(
    next,
...
await update("apps/web/app/staffing/page.tsx", (source) => {
  let next = replaceOnce(source, importAnchor, importWithConfirm, "staffing import");
  next = replaceOnce(
    next,
...
await update("apps/web/app/teaching-plan/page.tsx", (source) => {
  let next = replaceOnce(source, importAnchor, importWithConfirm, "teaching-plan import");
  next = replaceOnce(
    next,
